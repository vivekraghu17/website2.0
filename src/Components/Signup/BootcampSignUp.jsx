...
import styles from "../../Stylesheets/Signup/bootcampSignUp.module.scss";
...
export default function BootcampSignUp() {
  const [showPassword, setShowPassword] = React.useState(false);
  const navigate = useNavigate();
  return (
    <div className={styles["main-div"]}>
      <div className={styles["form-header-wrapper"]}>
        <div className={styles["heading"]}>Bootcamp Sign Up</div>
