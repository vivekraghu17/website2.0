...
import styles from "../../Stylesheets/Login/bootcampSignIn.module.scss";
...
export default function BootcampSignIn() {
  ...
  return (
    <div className={styles["main-div"]}>
      <div className={styles["form-header-wrapper"]}>
        <div className={styles["heading"]}>Bootcamp Sign In</div>
